...
cat(
'#################################################################
# Gene set Enrichment Analysis of TWAS Results
# V1.0 27/07/2018
...
# listAttributes(ensembl)$description
...
# Remove gene sets which have fewer than 5 genes available in the TWAS
...
# Check whether any variables are zero variance
# Remove variables that have a correlation of 1
